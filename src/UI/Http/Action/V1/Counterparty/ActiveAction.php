...
use App\Client\Command\Counterparty\Active\Command;
...
#[
    OA\Patch(
        path: '/v1/counterparty/{id}/active',
        description: 'Активация контрагента',
        security: [['bearerAuth' => '[]']],
        tags: ['counterparty'],
        responses: [
            new OA\Response(
                response: 204,
                description: 'Успешная активация контрагента',
            ),
            new OA\Response(
                response: 400,
