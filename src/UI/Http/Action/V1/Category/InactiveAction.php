...
use App\Store\Command\Category\Inactive\Command;
...
#[
    OA\Patch(
        path: '/v1/category/{id}/inactive',
        description: 'Деактивация категории',
        security: [['bearerAuth' => '[]']],
        tags: ['category'],
        responses: [
            new OA\Response(
                response: 204,
                description: 'Успешная деактивация категории',
            ),
            new OA\Response(
                response: 400,
