...
use App\Order\Command\PaymentMethod\Active\Command;
...
#[
    OA\Patch(
        path: '/v1/payment-method/{id}/active',
        description: 'Активация способа оплаты',
        security: [['bearerAuth' => '[]']],
        tags: ['payment-method'],
        responses: [
            new OA\Response(
                response: 204,
                description: 'Успешная активация способа оплаты',
            ),
            new OA\Response(
                response: 400,
