...
use App\Store\Command\Unit\Inactive\Command;
...
#[
    OA\Patch(
        path: '/v1/unit/{id}/inactive',
        description: 'Деактивация единицы измерения',
        security: [['bearerAuth' => '[]']],
        tags: ['unit'],
        responses: [
            new OA\Response(
                response: 204,
                description: 'Успешная деактивация единицы измерения',
            ),
            new OA\Response(
                response: 400,
