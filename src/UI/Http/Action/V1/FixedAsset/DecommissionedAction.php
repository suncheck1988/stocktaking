...
use App\Store\Command\FixedAsset\Decommissioned\Command;
...
#[
    OA\Patch(
        path: '/v1/fixed-asset/{id}/decommissioned',
        description: 'Списание основного средства',
        security: [['bearerAuth' => '[]']],
        tags: ['fixed-asset'],
        responses: [
            new OA\Response(
                response: 204,
                description: 'Успешное списание основного средства',
            ),
            new OA\Response(
                response: 400,
...
class DecommissionedAction extends AbstractAction
{
    /**
